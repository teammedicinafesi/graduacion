            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="telefono" class="col-md-4 col-form-label text-md-right">Num. Telefono</label>
                        ...
                        <div class="form-group row">
                            <label for="fiesta" class="col-md-4 col-form-label text-md-right">Fiesta</label>
                            <div class="col-md-6">
                                <select class="form-control" name="fiesta" required>
                                    <option value="">--</option>
                                    <option value="mayo">29 de Mayo</option>
                                    <option value="junio">5 de Junio</option>
                                </select>
                            </div>
                        </div>
